...
func shoot_to_tree(vel, tiempo_de_vida, objeto, angulo = 0, displacement = Vector2(0,0), roce = 0):
...
func shoot_child(vel, tiempo_de_vida, objeto, angulo = 0, displacement = Vector2(0,0), roce = 0):
	var bullet = objeto.instance()
	bullet.rotation_degrees = rotation_degrees + angulo
	bullet.velocidad_inicial = vel
	bullet.roce = roce
